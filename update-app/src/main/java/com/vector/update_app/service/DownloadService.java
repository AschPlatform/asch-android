...
//    }
    ...
    private void setUpNotification() {
        ...
        mBuilder.setContentTitle(this.getString(R.string.start_download))
                .setContentText(getString(R.string.connecting_server))
    ...
    private void startDownload(UpdateAppBean updateApp, final DownloadCallback callback) {
        ...
        if (TextUtils.isEmpty(apkUrl)) {
            String contentText =getString(R.string.wrong_download_path);
            stop(contentText);
            return;
        }
    ...
    class FileDownloadCallBack implements HttpManager.FileCallback {
        ...
        public void onProgress(float progress, long total) {
            ...
            if (oldRate != rate) {
                ...
                if (mBuilder != null) {
                    mBuilder.setContentTitle(getString(R.string.downloading) + AppUpdateUtils.getAppName(DownloadService.this))
                            .setContentText(rate + "%")
        ...
        public void onError(String error) {
            Toast.makeText(DownloadService.this, getString(R.string.update_app_error) + error, Toast.LENGTH_SHORT).show();
            //App前台运行
            if (mCallBack != null) {
