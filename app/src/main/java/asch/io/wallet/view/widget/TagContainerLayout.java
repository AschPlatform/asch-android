...
public class TagContainerLayout extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMaxLines = attributes.getInt(co.lujun.androidtagview.R.styleable.AndroidTagView_container_max_lines, mMaxLines);
        ...
        mTagHorizontalPadding = (int) attributes.getDimension(
                co.lujun.androidtagview.R.styleable.AndroidTagView_tag_horizontal_padding,
                dp2px(context, mTagHorizontalPadding));
        mTagVerticalPadding = (int) attributes.getDimension(
                co.lujun.androidtagview.R.styleable.AndroidTagView_tag_vertical_padding, dp2px(context, mTagVerticalPadding));
        ...
        mRippleColor = attributes.getColor(co.lujun.androidtagview.R.styleable.AndroidTagView_tag_ripple_color, Color.parseColor("#EEEEEE"));
        mRippleAlpha = attributes.getInteger(co.lujun.androidtagview.R.styleable.AndroidTagView_tag_ripple_alpha, mRippleAlpha);
        mRippleDuration = attributes.getInteger(co.lujun.androidtagview.R.styleable.AndroidTagView_tag_ripple_duration, mRippleDuration);
        mEnableCross = attributes.getBoolean(co.lujun.androidtagview.R.styleable.AndroidTagView_tag_enable_cross, mEnableCross);
        mCrossAreaWidth = attributes.getDimension(co.lujun.androidtagview.R.styleable.AndroidTagView_tag_cross_width,
                dp2px(context, mCrossAreaWidth));
        mCrossAreaPadding = attributes.getDimension(co.lujun.androidtagview.R.styleable.AndroidTagView_tag_cross_area_padding,
                dp2px(context, mCrossAreaPadding));
        mCrossColor = attributes.getColor(co.lujun.androidtagview.R.styleable.AndroidTagView_tag_cross_color, mCrossColor);
        mCrossLineWidth = attributes.getDimension(co.lujun.androidtagview.R.styleable.AndroidTagView_tag_cross_line_width,
                dp2px(context, mCrossLineWidth));
        mTagSupportLettersRTL = attributes.getBoolean(co.lujun.androidtagview.R.styleable.AndroidTagView_tag_support_letters_rlt,
                mTagSupportLettersRTL);
        mTagBackgroundResource = attributes.getResourceId(co.lujun.androidtagview.R.styleable.AndroidTagView_tag_background,
