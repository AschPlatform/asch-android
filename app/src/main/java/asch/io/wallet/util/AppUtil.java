...
import asch.io.wallet.activity.MainTabActivity;
...
public class AppUtil {
    ...
    public static String getTotalBalanceString(long total,int precision){
        return total==0?"0":decimalFormat(decimalFromBigint(total,precision));
    }
    ...
    public static String scaleStringFromBigAmount(String amount,int precision){
        BigDecimal big = new BigDecimal(amount);
    ...
    public static String getDateTimeFromTimestamp(Context context,long millis){
        int flags = DateUtils.FORMAT_SHOW_DATE
                |DateUtils.FORMAT_SHOW_YEAR
                |DateUtils.FORMAT_ABBREV_MONTH
